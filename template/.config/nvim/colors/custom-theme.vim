...
let s:theme00 = "#btheme00##"
let s:theme01 = "#btheme01##"
let s:theme02 = "#btheme02##"
let s:theme03 = "#btheme03##"
let s:theme04 = "#btheme04##"
let s:theme05 = "#btheme05##"
let s:theme06 = "#btheme06##"
let s:theme07 = "#btheme07##"
let s:theme08 = "#btheme08##"
let s:theme09 = "#btheme09##"
let s:theme0A = "#btheme0A##"
let s:theme0B = "#btheme0B##"
let s:theme0C = "#btheme0C##"
let s:theme0D = "#btheme0D##"
let s:theme0E = "#btheme0E##"
let s:theme0F = "#btheme0F##"
...
call <sid>hi("Folded",        s:theme02, s:theme00, "", "")
call <sid>hi("IncSearch",     s:theme09, s:theme00, "none", "")
...
call <sid>hi("Search",        s:theme09, s:theme08,  "", "")
call <sid>hi("Substitute",    s:theme09, s:theme08, "none", "")
...
call <sid>hi("WarningMsg",    s:theme06, "", "", "")
call <sid>hi("WildMenu",      s:theme06, s:theme08, "", "")
...
call <sid>hi("StatusLine",    s:theme0D, s:theme0C, "none", "")
call <sid>hi("StatusLineNC",  s:theme02, s:theme00, "none", "")
call <sid>hi("VertSplit",     s:theme0C, s:theme0C, "none", "")
call <sid>hi("ColorColumn",   "", s:theme09, "none", "")
...
call <sid>hi("PMenu",         s:theme03, s:theme09, "none", "")
call <sid>hi("PMenuSel",      s:theme09, s:theme04, "", "")
call <sid>hi("TabLine",       s:theme02, s:theme09, "none", "")
call <sid>hi("TabLineFill",   s:theme02, s:theme09, "none", "")
call <sid>hi("TabLineSel",    s:theme0B, s:theme09, "none", "")

" Standard syntax highlighting
call <sid>hi("Boolean",      s:theme07, "", "", "")
call <sid>hi("Character",    s:theme06, "", "", "")
call <sid>hi("Comment",      s:theme02, "", "", "")
call <sid>hi("Conditional",  s:theme0F, "", "", "")
call <sid>hi("Constant",     s:theme07, "", "", "")
call <sid>hi("Define",       s:theme0F, "", "none", "")
call <sid>hi("Delimiter",    s:theme05, "", "", "")
call <sid>hi("Float",        s:theme07, "", "", "")
call <sid>hi("Function",     s:theme0D, "", "", "")
call <sid>hi("Identifier",   s:theme06, "", "none", "")
call <sid>hi("Include",      s:theme0D, "", "", "")
call <sid>hi("Keyword",      s:theme0F, "", "", "")
...
call <sid>hi("Statement",    s:theme06, "", "", "")
call <sid>hi("StorageClass", s:theme08, "", "", "")
call <sid>hi("String",       s:theme0B, "", "", "")
call <sid>hi("Structure",    s:theme0F, "", "", "")
call <sid>hi("Tag",          s:theme08, "", "", "")
call <sid>hi("Todo",         s:theme08, s:theme09, "", "")
call <sid>hi("Type",         s:theme08, "", "none", "")
call <sid>hi("Typedef",      s:theme08, "", "", "")

" C highlighting
call <sid>hi("cOperator",   s:theme0A, "", "", "")
call <sid>hi("cPreCondit",  s:theme0F, "", "", "")

" C# highlighting
call <sid>hi("csClass",                 s:theme08, "", "", "")
call <sid>hi("csAttribute",             s:theme08, "", "", "")
call <sid>hi("csModifier",              s:theme0F, "", "", "")
call <sid>hi("csType",                  s:theme06, "", "", "")
call <sid>hi("csUnspecifiedStatement",  s:theme0D, "", "", "")
call <sid>hi("csContextualStatement",   s:theme0F, "", "", "")
call <sid>hi("csNewDecleration",        s:theme06, "", "", "")

" CSS highlighting
call <sid>hi("cssBraces",      s:theme03, "", "", "")
call <sid>hi("cssClassName",   s:theme0F, "", "", "")
call <sid>hi("cssColor",       s:theme0A, "", "", "")

" Diff highlighting
call <sid>hi("DiffAdd",      s:theme0B, s:theme09, "", "")
call <sid>hi("DiffChange",   s:theme02, s:theme09, "", "")
call <sid>hi("DiffDelete",   s:theme06, s:theme09, "", "")
call <sid>hi("DiffText",     s:theme0D, s:theme09, "", "")
call <sid>hi("DiffAdded",    s:theme0B, s:theme00, "", "")
call <sid>hi("DiffFile",     s:theme06, s:theme00, "", "")
call <sid>hi("DiffNewFile",  s:theme0B, s:theme00, "", "")
call <sid>hi("DiffLine",     s:theme0D, s:theme00, "", "")
call <sid>hi("DiffRemoved",  s:theme06, s:theme00, "", "")

" Git highlighting
call <sid>hi("gitcommitOverflow",       s:theme06, "", "", "")
call <sid>hi("gitcommitSummary",        s:theme0B, "", "", "")
call <sid>hi("gitcommitComment",        s:theme02, "", "", "")
call <sid>hi("gitcommitUntracked",      s:theme02, "", "", "")
call <sid>hi("gitcommitDiscarded",      s:theme02, "", "", "")
call <sid>hi("gitcommitSelected",       s:theme02, "", "", "")
call <sid>hi("gitcommitHeader",         s:theme0F, "", "", "")
...
call <sid>hi("GitGutterAdd",     s:theme0B, s:theme09, "", "")
call <sid>hi("GitGutterChange",  s:theme0D, s:theme09, "", "")
call <sid>hi("GitGutterDelete",  s:theme06, s:theme09, "", "")
call <sid>hi("GitGutterChangeDelete",  s:theme0F, s:theme09, "", "")

" HTML highlighting
call <sid>hi("htmlBold",    s:theme08, "", "", "")
call <sid>hi("htmlItalic",  s:theme0F, "", "", "")
...
call <sid>hi("mailQuoted3",  s:theme0F, "", "", "")
...
call <sid>hi("markdownError",             s:theme03, s:theme00, "", "")
...
" Python highlighting
call <sid>hi("pythonOperator",  s:theme0F, "", "", "")
call <sid>hi("pythonRepeat",    s:theme0F, "", "", "")
call <sid>hi("pythonInclude",   s:theme0F, "", "", "")
call <sid>hi("pythonStatement", s:theme0F, "", "", "")
...
call <sid>hi("sassInclude",    s:theme0F, "", "", "")
call <sid>hi("sassMixing",     s:theme0F, "", "", "")
...
call <sid>hi("SpellRare",    "", "", "undercurl", s:theme0F)
...
call <sid>hi("StartifySection",  s:theme0F, "", "", "")
